...
import com.zhiren.wuljg.activity.ChuanYunJie_JieCheActivity;
 ...
 * 
 */
public class ChuanYunJie_JieCheAdapter extends BaseAdapter {
	...
	public ChuanYunJie_JieCheAdapter(Activity context, List<JCInfo> list, Handler handler) {
	...
	public View getView( final int position, View convertView, ViewGroup parent) {
		...
		holder.iv_camera.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				msg.what = ChuanYunJie_JieCheActivity.PAIZHAO;
				msg.obj = jcInfo ;
