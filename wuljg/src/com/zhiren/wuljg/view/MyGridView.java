...
public class MyGridView extends GridView {
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		//	localPaint.setColor(Color.parseColor("#C12817"));
			localPaint.setColor(Color.parseColor("#000000"));
		//	localPaint2.setColor(Color.parseColor("#F75845"));
			localPaint2.setColor(Color.parseColor("#000000"));
