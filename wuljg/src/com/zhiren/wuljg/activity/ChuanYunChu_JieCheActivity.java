...
import com.zhiren.wuljg.activity.ChuanYunChu_FaCheAndPiDaiActivity.MyLocationListener;
import com.zhiren.wuljg.activity.ChuanYunChu_FaCheAndPiDaiActivity.MyReceiver;
import com.zhiren.wuljg.adapter.JieCheAdapter;
 ...
 * 
 */
public class ChuanYunChu_JieCheActivity extends BaseActivity implements
		OnClickListener, IXListViewListener {

	public static final int PAIZHAO = 8;
	public static final int JIECHE_SUCCESS = 9;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		jigtdid = (long) getIntent().getExtras().get("jigtdid");
	...
	private void regist() {
		...
		filter.addAction("com.zhiren.chujieche");
		registerReceiver(myReceiver, filter);
	}

	private void init() {
		loading = new DialogLoading(ChuanYunChu_JieCheActivity.this);
		...
		public boolean handleMessage(Message msg) {
			...
			case Constant.SUCCESS:
				...
				if (infos != null && infos.rspsys != null
					...
					JieCheAdapter adapter = new JieCheAdapter(
							ChuanYunChu_JieCheActivity.this, lists, handler);
					if (adapter != null) {
			...
			case Constant.ERROR:
				ToastUtil.ShowMessage(ChuanYunChu_JieCheActivity.this, msg.obj
						+ "");
				break;

			case Constant.EXCEPTION:
				ToastUtil.ShowMessage(ChuanYunChu_JieCheActivity.this, "异常");
				break;

			case JIECHE_SUCCESS:
				getDataFromNet(jigtdid);
				ToastUtil.ShowMessage(ChuanYunChu_JieCheActivity.this, "接车成功");
				break;

			case PAIZHAO:
				JCInfo jcInfo = (JCInfo) msg.obj;
				isfrom = "jieche";
				Intent intent2 = new Intent(ChuanYunChu_JieCheActivity.this,
						TakePicAndUpload_Activity.class);
				intent2.putExtra("camera_position", "315_1"); 
				intent2.putExtra("code", code);
				intent2.putExtra("place", latitude + "," + longitude);
				intent2.putExtra("yw_type", "chuanyfy"); // 集港短倒
				intent2.putExtra("business", "qicdycph");  
	...
	private void getDataFromNet(final long jgtdId) {
		...
		if (!NetUtil.isNetworkConnected(ChuanYunChu_JieCheActivity.this)) {
			ToastUtil.ShowMessage(ChuanYunChu_JieCheActivity.this,
			...
			public void run() {
				...
				try {
					...
					Result result = ApiResult.getServerArrayResult1(
							ChuanYunChu_JieCheActivity.this,
	...
	private void onLoad() {
		ToastUtil.ShowMessage(ChuanYunChu_JieCheActivity.this, "刷新了");
		getDataFromNet(jigtdid);
